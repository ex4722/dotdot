...
Visit the current repository's issues using a browser." t nil)

(autoload 'forge-browse-pullreqs "forge-commands" "\
Visit the current repository's pull-requests using a browser." t nil)
...
Visit the topic at point using a browser." t nil)

(autoload 'forge-browse-this-repository "forge-commands" "\
Visit the repository at point using a browser." t nil)
...
Visit the thing at point using a browser." t nil)
...
Visit the topic at point." t nil)

(autoload 'forge-visit-this-repository "forge-commands" "\
Visit the repository at point." t nil)
