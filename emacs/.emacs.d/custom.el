(custom-set-variables
 ...
 '(package-selected-packages
   '(calfw-org calfw-ical calfw-cal calfw sunshine org-caldav undo-tree evil-nerd-commenter lsp-ivy company-box company lsp-pyright lsp-mode tree-sitter-langs tree-sitter org-roam-ui org-roam emacsql-sqlite visual-fill-column org-bullets forge magit counsel-projectile rainbow-delimiters which-key goto-chg)))
(custom-set-faces
