...
(if (eq system-type 'darwin)
    (set-face-attribute 'default nil :font "JetBrainsMono Nerd Font" :height 230)
  (set-face-attribute 'default nil :font "JetBrainsMono Nerd Font Mono" :height 230)
)
...
(defun efs/org-babel-tangle-config ()
  (when ( or (string-equal (buffer-file-name)
			     ...
			     ) (string-equal (buffer-file-name) (expand-file-name "~/.emacs.d/init.org"))
			       )
