...
then
    ...
    xrandr --output eDP-1 --primary --mode 1920x1200 --pos 2560x240 --rotate normal --output DP-1 --off --output HDMI-1 --off --output DP-2 --off --output DP-3 --off --output DP-4 --off
fi
